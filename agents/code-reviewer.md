---
description: Reviews code written by other agents. Invoke after any code changes are made. Returns a structured JSON review. The build agent must read the verdict and act on it before considering the task complete.
mode: subagent
